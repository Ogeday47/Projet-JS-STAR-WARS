...
function displayDetail(event) {
  ...
  document.querySelector('#population').textContent = 'Population: '+ planet.population;
  document.querySelector('#diameter').textContent = planet.diameter;
  document.querySelector('#climate').textContent = planet.climate;
  document.querySelector('#gravity').textContent = planet.gravity;
  document.querySelector('#terrain').textContent = planet.terrain;
